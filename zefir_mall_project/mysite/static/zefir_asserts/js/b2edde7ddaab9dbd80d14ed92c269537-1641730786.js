...
let cookiecook = getCookie("cookiecook"),
  cookiewin = document.getElementsByClassName('cookies_content')[0];

if (cookiecook != "no") {
  cookiewin.style.cssText = "visibility: visible; opacity: 1; transition: all 0.3s;";
  document.getElementById("cookie_close").addEventListener("click", function () {
    cookiewin.style.cssText = "visibility: hidden; opacity: 0; transition: all 0.3s; z-index: -10;";
    let date = new Date;
  ...
  function animOnScroll() {
    for (let index = 0; index < animItems.length; index++) {
      ...
      if ((pageYOffset > animItemOffset - animItemPoint) && pageYOffset < (animItemOffset + animItemHeight)) {
        ...
        if (!animItem.classList.contains('_anim_no')) {
...
$(document).ready(function () {
  //$(".phone").mask("(480) 999-9999"); // маска для всех инпутов с классом .phone
...
function onYouTubeIframeAPIReady() {
  $(".video-bl").each(function (key) {
    ...
    $(this).html(
      ...
      bgImageUrl +
      ')"><svg class="play-icn" width="159" height="159" viewBox="0 0 159 159" fill="none"xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd"d="M79.023 158.046C122.666 158.046 158.046 122.666 158.046 79.023C158.046 35.3798 122.666 0 79.023 0C35.3798 0 0 35.3798 0 79.023C0 122.666 35.3798 158.046 79.023 158.046ZM106.488 83.4372C110.466 81.1076 110.466 75.3583 106.488 73.0287L69.1369 51.1514C65.1162 48.7965 60.0575 51.6961 60.0575 56.3557L60.0575 100.11C60.0575 104.77 65.1162 107.669 69.1369 105.314L106.488 83.4372Z"fill="white" /></svg></div></div>'
    );
  });
}
...
var burgerCtr1 = document.querySelector(".close_mobile");
var menuCtr = document.querySelector("#mobile-menu");
burgerCtr1.addEventListener("click", function () {
  this.classList.toggle("active");
  menuCtr.classList.toggle("show_mobile_menu");
});

var lazyLoadInstance = new LazyLoad({});
$('.lang_list .lang_item').on('click', function () {
  $(this).toggleClass('active');
});

$('.mob_ov').on('click', function () {
...
$('#burger-menu').on('click', function () {
  $('.mob_ov').addClass('show');
});

$('.close_mobile').on('click', function () {
  $('.mob_ov').removeClass('show');
});
